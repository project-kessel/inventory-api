...
func _KesselInventoryHealthService_GetLivez0_HTTP_Handler(srv KesselInventoryHealthServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationKesselInventoryHealthServiceGetLivez)
...
func _KesselInventoryHealthService_GetReadyz0_HTTP_Handler(srv KesselInventoryHealthServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetReadyzRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationKesselInventoryHealthServiceGetReadyz)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func NewKesselInventoryHealthServiceHTTPClient(client *http.Client) KesselInventoryHealthServiceHTTPClient {
	return &KesselInventoryHealthServiceHTTPClientImpl{client}
}
