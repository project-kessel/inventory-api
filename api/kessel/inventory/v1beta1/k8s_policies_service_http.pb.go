...
const OperationKesselK8SPolicyServiceCreateK8sPolicy = "/kessel.inventory.v1beta1.KesselK8sPolicyService/CreateK8sPolicy"
const OperationKesselK8SPolicyServiceDeleteK8sPolicy = "/kessel.inventory.v1beta1.KesselK8sPolicyService/DeleteK8sPolicy"
const OperationKesselK8SPolicyServiceUpdateK8sPolicy = "/kessel.inventory.v1beta1.KesselK8sPolicyService/UpdateK8sPolicy"
...
func RegisterKesselK8SPolicyServiceHTTPServer(s *http.Server, srv KesselK8SPolicyServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/api/inventory/v1beta1/k8s-policies", _KesselK8SPolicyService_CreateK8SPolicy0_HTTP_Handler(srv))
	r.PUT("/api/inventory/v1beta1/k8s-policies/{resource}", _KesselK8SPolicyService_UpdateK8SPolicy0_HTTP_Handler(srv))
	r.DELETE("/api/inventory/v1beta1/k8s-policies/{resource}", _KesselK8SPolicyService_DeleteK8SPolicy0_HTTP_Handler(srv))
}
...
func (c *KesselK8SPolicyServiceHTTPClientImpl) CreateK8SPolicy(ctx context.Context, in *CreateK8SPolicyRequest, opts ...http.CallOption) (*CreateK8SPolicyResponse, error) {
	...
	pattern := "/api/inventory/v1beta1/k8s-policies"
...
func (c *KesselK8SPolicyServiceHTTPClientImpl) DeleteK8SPolicy(ctx context.Context, in *DeleteK8SPolicyRequest, opts ...http.CallOption) (*DeleteK8SPolicyResponse, error) {
	...
	pattern := "/api/inventory/v1beta1/k8s-policies/{resource}"
