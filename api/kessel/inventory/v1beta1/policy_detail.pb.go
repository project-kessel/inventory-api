...
// The kind of policy
type PolicyDetail_Severity int32

const (
	PolicyDetail_SEVERITY_UNSPECIFIED PolicyDetail_Severity = 0
	PolicyDetail_SEVERITY_LOW         PolicyDetail_Severity = 1
	PolicyDetail_SEVERITY_MEDIUM      PolicyDetail_Severity = 2
	PolicyDetail_SEVERITY_HIGH        PolicyDetail_Severity = 3
	PolicyDetail_SEVERITY_CRITICAL    PolicyDetail_Severity = 4
	PolicyDetail_SEVERITY_OTHER       PolicyDetail_Severity = 5
)

// Enum value maps for PolicyDetail_Severity.
var (
	PolicyDetail_Severity_name = map[int32]string{
	...
	PolicyDetail_Severity_value = map[string]int32{
...
func (x PolicyDetail_Severity) Enum() *PolicyDetail_Severity {
	p := new(PolicyDetail_Severity)
	*p = x
	return p
}

func (x PolicyDetail_Severity) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PolicyDetail_Severity) Descriptor() protoreflect.EnumDescriptor {
	return file_kessel_inventory_v1beta1_policy_detail_proto_enumTypes[0].Descriptor()
}

func (PolicyDetail_Severity) Type() protoreflect.EnumType {
	return &file_kessel_inventory_v1beta1_policy_detail_proto_enumTypes[0]
}

func (x PolicyDetail_Severity) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PolicyDetail_Severity.Descriptor instead.
func (PolicyDetail_Severity) EnumDescriptor() ([]byte, []int) {
...
type PolicyDetail struct {
	...
	Severity PolicyDetail_Severity `protobuf:"varint,404558591,opt,name=severity,proto3,enum=kessel.inventory.v1beta1.PolicyDetail_Severity" json:"severity,omitempty"`
}
...
func (x *PolicyDetail) GetSeverity() PolicyDetail_Severity {
	if x != nil {
		return x.Severity
	}
	return PolicyDetail_SEVERITY_UNSPECIFIED
}
...
var file_kessel_inventory_v1beta1_policy_detail_proto_rawDesc = []byte{
	...
	0x79, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x18,
	0x6b, 0x65, 0x73, 0x73, 0x65, 0x6c, 0x2e, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79,
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x22, 0x8b, 0x02, 0x0a, 0x0c, 0x50, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x1e, 0x0a, 0x08, 0x64, 0x69, 0x73,
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0xfc, 0xf4, 0x98, 0x81, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x4f, 0x0a, 0x08, 0x73, 0x65, 0x76,
	0x65, 0x72, 0x69, 0x74, 0x79, 0x18, 0xff, 0xa5, 0xf4, 0xc0, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x53, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79,
	0x52, 0x08, 0x73, 0x65, 0x76, 0x65, 0x72, 0x69, 0x74, 0x79, 0x22, 0x89, 0x01, 0x0a, 0x08, 0x53,
	...
	0x10, 0x04, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x45, 0x56, 0x45, 0x52, 0x49, 0x54, 0x59, 0x5f, 0x4f,
	0x54, 0x48, 0x45, 0x52, 0x10, 0x05, 0x42, 0x72, 0x0a, 0x28, 0x6f, 0x72, 0x67, 0x2e, 0x70, 0x72,
	...
	0x61, 0x31, 0x50, 0x01, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var file_kessel_inventory_v1beta1_policy_detail_proto_goTypes = []any{
	(PolicyDetail_Severity)(0), // 0: kessel.inventory.v1beta1.PolicyDetail.Severity
	(*PolicyDetail)(nil),       // 1: kessel.inventory.v1beta1.PolicyDetail
}
var file_kessel_inventory_v1beta1_policy_detail_proto_depIdxs = []int32{
	0, // 0: kessel.inventory.v1beta1.PolicyDetail.severity:type_name -> kessel.inventory.v1beta1.PolicyDetail.Severity
