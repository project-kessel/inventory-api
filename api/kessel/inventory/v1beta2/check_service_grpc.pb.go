...
const (
	KesselCheckService_Check_FullMethodName          = "/kessel.inventory.v1beta2.KesselCheckService/Check"
	KesselCheckService_CheckForUpdate_FullMethodName = "/kessel.inventory.v1beta2.KesselCheckService/CheckForUpdate"
)
