...
func (x *Relationship) Reset() {
	*x = Relationship{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[0]
...
func (*Relationship) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{0}
}
...
func (x *SubjectReference) Reset() {
	*x = SubjectReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SubjectReference) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{1}
}
...
func (x *RequestPagination) Reset() {
	*x = RequestPagination{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RequestPagination) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{2}
}
...
func (x *ResponsePagination) Reset() {
	*x = ResponsePagination{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResponsePagination) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{3}
}
...
func (x *ObjectReference) Reset() {
	*x = ObjectReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ObjectReference) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{4}
}
...
func (x *ObjectType) Reset() {
	*x = ObjectType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ObjectType) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{5}
}
...
func (x *Consistency) Reset() {
	*x = Consistency{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Consistency) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{6}
}
...
func (x *ConsistencyToken) Reset() {
	*x = ConsistencyToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_kessel_inventory_v1beta2_common_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConsistencyToken) Descriptor() ([]byte, []int) {
	return file_kessel_inventory_v1beta2_common_proto_rawDescGZIP(), []int{7}
}
...
var File_kessel_inventory_v1beta2_common_proto protoreflect.FileDescriptor

var file_kessel_inventory_v1beta2_common_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x32, 0x2e, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65,
	...
	0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x32, 0x2e, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0x06, 0xba, 0x48,
...
var (
	file_kessel_inventory_v1beta2_common_proto_rawDescOnce sync.Once
	file_kessel_inventory_v1beta2_common_proto_rawDescData = file_kessel_inventory_v1beta2_common_proto_rawDesc
)

func file_kessel_inventory_v1beta2_common_proto_rawDescGZIP() []byte {
	file_kessel_inventory_v1beta2_common_proto_rawDescOnce.Do(func() {
		file_kessel_inventory_v1beta2_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_kessel_inventory_v1beta2_common_proto_rawDescData)
	})
	return file_kessel_inventory_v1beta2_common_proto_rawDescData
}

var file_kessel_inventory_v1beta2_common_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_kessel_inventory_v1beta2_common_proto_goTypes = []any{
	...
	(*ResponsePagination)(nil), // 3: kessel.inventory.v1beta2.ResponsePagination
	(*ObjectReference)(nil),    // 4: kessel.inventory.v1beta2.ObjectReference
	(*ObjectType)(nil),         // 5: kessel.inventory.v1beta2.ObjectType
	(*Consistency)(nil),        // 6: kessel.inventory.v1beta2.Consistency
	(*ConsistencyToken)(nil),   // 7: kessel.inventory.v1beta2.ConsistencyToken
}
var file_kessel_inventory_v1beta2_common_proto_depIdxs = []int32{
	4, // 0: kessel.inventory.v1beta2.Relationship.resource:type_name -> kessel.inventory.v1beta2.ObjectReference
	1, // 1: kessel.inventory.v1beta2.Relationship.subject:type_name -> kessel.inventory.v1beta2.SubjectReference
	4, // 2: kessel.inventory.v1beta2.SubjectReference.subject:type_name -> kessel.inventory.v1beta2.ObjectReference
	5, // 3: kessel.inventory.v1beta2.ObjectReference.type:type_name -> kessel.inventory.v1beta2.ObjectType
	7, // 4: kessel.inventory.v1beta2.Consistency.at_least_as_fresh:type_name -> kessel.inventory.v1beta2.ConsistencyToken
...
func init() { file_kessel_inventory_v1beta2_common_proto_init() }
func file_kessel_inventory_v1beta2_common_proto_init() {
	if File_kessel_inventory_v1beta2_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_kessel_inventory_v1beta2_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_kessel_inventory_v1beta2_common_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_kessel_inventory_v1beta2_common_proto_msgTypes[1].OneofWrappers = []any{}
	file_kessel_inventory_v1beta2_common_proto_msgTypes[2].OneofWrappers = []any{}
	file_kessel_inventory_v1beta2_common_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_kessel_inventory_v1beta2_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kessel_inventory_v1beta2_common_proto_goTypes,
		DependencyIndexes: file_kessel_inventory_v1beta2_common_proto_depIdxs,
		MessageInfos:      file_kessel_inventory_v1beta2_common_proto_msgTypes,
	}.Build()
	File_kessel_inventory_v1beta2_common_proto = out.File
	file_kessel_inventory_v1beta2_common_proto_rawDesc = nil
	file_kessel_inventory_v1beta2_common_proto_goTypes = nil
	file_kessel_inventory_v1beta2_common_proto_depIdxs = nil
}
