...
type Consistency_AtLeastAsAcknowledged struct {
	...
	// Set to true to enable inventory-managed resources, otherwise minimizeLatency is the default behaviour.
...
const file_kessel_inventory_v1beta2_consistency_proto_rawDesc = "" +
	"\n" +
	"*kessel/inventory/v1beta2/consistency.proto\x12\x18kessel.inventory.v1beta2\x1a\x1bbuf/validate/validate.proto\x1a0kessel/inventory/v1beta2/consistency_token.proto\"\xed\x01\n" +
	"\vConsistency\x124\n" +
	"\x10minimize_latency\x18\x01 \x01(\bB\a\xbaH\x04j\x02\b\x01H\x00R\x0fminimizeLatency\x12W\n" +
	"\x11at_least_as_fresh\x18\x02 \x01(\v2*.kessel.inventory.v1beta2.ConsistencyTokenH\x00R\x0eatLeastAsFresh\x129\n" +
	"\x18at_least_as_acknowledged\x18\x03 \x01(\bH\x00R\x15atLeastAsAcknowledgedB\x14\n" +
