...
kind create cluster --config deploy/kind/relations/spicedb-kind-setup/kind-kube/kind-ingress.config

echo "> waiting for kubernetes node(s) become ready"
kubectl wait --for=condition=ready node --all --timeout=60s

echo "deploy contour"
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/kind-kube/contour.yaml
...
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/postgres/secret.yaml -n spicedb
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/postgres/storage.yaml -n spicedb
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/postgres/postgresql.yaml -n spicedb

echo "deploy spicedb"
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/spicedb-cr.yaml -n spicedb
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/svc-ingress.yaml -n spicedb
...
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/relations-api/secret.yaml -n spicedb
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/relations-api/deployment.yaml -n spicedb
kubectl apply -f ./deploy/kind/relations/spicedb-kind-setup/relations-api/svc.yaml -n spicedb
