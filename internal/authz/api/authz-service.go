...
type Authorizer interface {
	...
	Check(context.Context, string, string, *model.Representation, *kessel.SubjectReference) (kessel.CheckResponse_Allowed, *kessel.ConsistencyToken, error)
	CheckForUpdate(context.Context, string, string, *model.Representation, *kessel.SubjectReference) (kessel.CheckForUpdateResponse_Allowed, *kessel.ConsistencyToken, error)
