...
type ResourceRepository interface {
	...
	FindCurrentAndPreviousVersionedRepresentations(tx *gorm.DB, key ReporterResourceKey, currentCommonVersion *Version, currentReporterVersion *Version, operationType EventOperationType) (*Representations, *Representations, error)
