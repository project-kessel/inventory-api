...
func (f TupleSubjectFilter) WithSubjectType(t ResourceType) TupleSubjectFilter {
	f.subjectType = &t
	return f
}
func (f TupleSubjectFilter) WithReporterType(t ReporterType) TupleSubjectFilter {
	f.reporterType = &t
	return f
}
func (f TupleSubjectFilter) WithSubjectId(id LocalResourceId) TupleSubjectFilter {
	f.subjectId = &id
	return f
}
