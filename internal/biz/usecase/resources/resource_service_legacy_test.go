...
func TestLookupResources_Success(t *testing.T) {
	...
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), authz, nil, "", log.DefaultLogger, nil, cb, usecaseConfig, nil)
...
func TestCreateReturnsDbError(t *testing.T) {
	...
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), nil, nil, "", log.DefaultLogger, nil, cb, defaultUseCaseConfig, mc)
	ctx := context.TODO()
...
func TestCreateNewResource(t *testing.T) {
	...
	mc := metricscollector.NewFakeMetricsCollector()
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), nil, nil, "", log.DefaultLogger, listenMan, cb, defaultUseCaseConfig, mc)
	ctx := context.TODO()
...
func TestCreateNewResource_ConsumerDisabled(t *testing.T) {
	...
	mc := metricscollector.NewFakeMetricsCollector()
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), nil, nil, "", log.DefaultLogger, listenMan, cb, usecaseConfig, mc)
	ctx := context.TODO()
...
func TestCreateNewResource_ConsistencyToken(t *testing.T) {
	...
	mc := metricscollector.NewFakeMetricsCollector()
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), m, nil, "", log.DefaultLogger, listenMan, cb, usecaseConfig, mc)
	ctx := context.TODO()
...
func TestUpdate_ReadAfterWrite(t *testing.T) {
	...
	mc := metricscollector.NewFakeMetricsCollector()
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), authz, nil, "", log.DefaultLogger, listenMan, cb, usecaseConfig, mc)
	ctx := context.TODO()
...
func TestCheck_MissingResource(t *testing.T) {
	...
	mc := metricscollector.NewFakeMetricsCollector()
	useCase := New(nil, repo, inventoryRepo, data.NewInMemorySchemaRepository(), m, nil, "", log.DefaultLogger, nil, cb, defaultUseCaseConfig, mc)
