...
// Lookup figures out which Producer should be used for the given claims and resource.
func (m *StdOutManager) Lookup(claims *authnapi.Claims, resource_type string, resource_id uuid.UUID) (api.Producer, error) {
	return m, nil
}
