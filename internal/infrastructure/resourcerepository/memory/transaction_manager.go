...
// FakeTransactionManager is a test implementation of [resourcerepository.TransactionManager]
...
var _ resourcerepository.TransactionManager = (*FakeTransactionManager)(nil)
