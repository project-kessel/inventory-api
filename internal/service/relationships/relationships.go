...
func (c *RelationshipsService) UpdateK8SPolicyIsPropagatedToK8SCluster(ctx context.Context, r *relationships.UpdateK8SPolicyIsPropagatedToK8SClusterRequest) (*relationships.UpdateK8SPolicyIsPropagatedToK8SClusterResponse, error) {
	return nil, nil
}

func (c *RelationshipsService) DeleteK8SPolicyIsPropagatedToK8SCluster(ctx context.Context, r *relationships.DeleteK8SPolicyIsPropagatedToK8SClusterRequest) (*relationships.DeleteK8SPolicyIsPropagatedToK8SClusterResponse, error) {
	return nil, nil
}
