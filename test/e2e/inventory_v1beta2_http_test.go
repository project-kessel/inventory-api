...
func TestInventoryAPIHTTP_v1beta2_AuthzLifecycle(t *testing.T) {
	...
	assert.Equal(t, authzbeta2.CheckResponse_ALLOWED_FALSE, checkResp.Allowed, "expected check to return ALLOWED_FALSE")
	...
	assert.Equal(t, authzbeta2.CheckResponse_ALLOWED_TRUE, checkUpdateResp.Allowed, "expected checkforupdate to return ALLOWED_TRUE")
}
